...
const Navbar = () => {
  ...
  return (
    <div className="px-10 py-6 flex items-center justify-between bg-gray-800 p-4 text-white">
      {/* LOGO */}
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.nav
            ...
            className="absolute top-0 left-0 w-full h-screen bg-gray-800 px-10 py-6 md:hidden text-white flex flex-col items-start justify-center gap-6 text-5xl"
          >
